...
export function generateArchitecturalDesign(params: GenerateDesignParams): {
  ...
  // Determine room arrangement strategy based on alternative
  // Alternative A: Space Optimized (Max open plan, efficient circulation)
  // Alternative B: Budget Optimized (Standard grid, simplified spans)
  // Alternative C: Vastu Optimized (Strict Ishanya NE pooja, Agneya SE kitchen, Nairutya SW master)
  // Alternative D: Luxury / Executive (Spacious master suite, walk-in closets, grand foyer)
  ...
  const qualityTier: QualityTier = style === 'Luxury' ? 'Premium' : budget.totalBudget > 4500000 ? 'Standard' : 'Economy';
